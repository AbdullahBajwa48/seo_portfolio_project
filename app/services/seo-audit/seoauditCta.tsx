      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="bg-[#141414] border border-gray-800 rounded-2xl
          ...
          >
            ...
            <span className="text-orange-500">With Your SEO</span>
          </motion.h2>
          ...
          >
            Stop guessing. Get a complete picture of your website&apos;s SEO health —
            technical issues, content gaps, backlink profile, local presence, and
          ...
          >
            {["✓ No lock-in contracts", "✓ Plain English explanations", "✓ Direct access to Bhavleen", "✓ 5–7 day turnaround"].map((item) => (
