      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              SEO Audit Melbourne —{" "}
              <span className="text-orange-500">Know Exactly What&apos;s Holding You Back</span>
            </motion.h1>
            ...
            >
              A comprehensive audit of your website&apos;s technical health, content
              quality, on-page optimisation, backlinks, and local presence. No
              guesswork — just a clear roadmap to better rankings.
            </motion.p>
            ...
            >
              Before you invest in SEO, you need to know where you stand. My SEO audit
              uncovers every issue affecting your visibility — and gives you a
              prioritised action plan to fix them.
            </motion.p>
            ...
            >
              {["✓ 5–7 day turnaround", "✓ Manual analysis", "✓ Walkthrough call included", "✓ No jargon"].map((item) => (
          ...
          >
            {[
              ...
              { value: "5–7", label: "Business days to complete" },
              { value: "100%", label: "Manual review — not automated" },
