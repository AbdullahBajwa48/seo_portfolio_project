    ...
    <section className="bg-[#0f0f0f] py-24 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        <div className="max-w-3xl mx-auto space-y-5 mb-14">
          ...
          >
            Rankings mean nothing if they don't bring customers through the door.
          </motion.p>
          ...
          >
            At Khalis Marketing, every SEO service is designed with one goal: growing
            your business. Whether you need to dominate local search, fix technical
            issues holding your site back, or future-proof your visibility for
            AI-driven search — I'll build a strategy that fits your needs and budget.
          </motion.p>
          ...
          <motion.p
            ...
            className="text-gray-400 text-base leading-relaxed text-center"
          >
            No long-term contracts. No disappearing after the invoice. Just honest,
            effective SEO from a Melbourne consultant who does the work himself.
          </motion.p>
        </div>
