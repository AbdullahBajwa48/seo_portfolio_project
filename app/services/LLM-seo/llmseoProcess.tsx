...
const steps = [
  {
    ...
    desc: "I test how your business currently appears when relevant questions are asked across major AI platforms. This reveals your baseline visibility.",
    time: "3–5 days",
  },
  {
    number: "02",
    title: "Gap Analysis",
    desc: "I compare your presence against competitors who are getting cited. What are they doing that you're not? Where are the opportunities?",
    time: "1 week",
  },
  {
    number: "03",
    title: "Strategy Development",
    desc: "Based on the audit, I create an AEO strategy — content improvements, structured data, E-E-A-T signals, and brand mention opportunities.",
    time: "1 week",
  },
  {
    number: "04",
    title: "Implementation",
    desc: "I execute the strategy — optimising content, adding schema markup, building authoritative mentions, and strengthening trust signals.",
    time: "1–2 weeks",
  },
  {
    number: "05",
    title: "Monitor & Adapt",
    desc: "AI platforms evolve constantly. I track your visibility in AI-generated answers and refine the approach as the landscape changes.",
    time: "Monthly",
  },
];

export default function LlmSeoProcess() {
  ...
  return (
    <section className="bg-[#0a0a0a] py-24 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          How I Approach{" "}
          <span className="text-orange-500">AEO</span>
        </motion.h2>
