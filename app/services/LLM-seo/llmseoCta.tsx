...
export default function LlmSeoCta() {
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="bg-[#141414] border border-gray-800 rounded-2xl
          ...
          >
            Ready for the{" "}
            <span className="text-orange-500">Future of Search?</span>
          </motion.h2>
          ...
          >
            Find out how visible your business is in AI-powered search. Get an AEO audit
            and I&apos;ll show you exactly where you stand in ChatGPT, Perplexity, and Google
            AI Overviews — plus what it takes to get recommended.
          </motion.p>
          ...
          >
            {["✓ No lock-in contracts", "✓ ChatGPT & Perplexity audit", "✓ Direct access to Bhavleen", "✓ Honest, practical advice"].map((item) => (
