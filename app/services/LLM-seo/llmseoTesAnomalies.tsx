...
const testimonials = [
  {
    quote: "I had no idea people were asking ChatGPT for recommendations in my industry. Bhavleen showed me we weren't appearing at all — now we're getting mentioned consistently.",
    name: "Client Name",
    role: "Business Type, Melbourne",
    initials: "CN",
    result: "Consistent AI Citations",
  },
  {
    quote: "AEO felt like something for the future, but Bhavleen made it practical and showed real results. We're now showing up in AI answers alongside much bigger competitors.",
    name: "Client Name",
    role: "Business Type, Melbourne",
    initials: "CN",
    result: "Visible in AI Search",
  },
];

const stats = [
  { value: "3+", label: "AI platforms optimised" },
  { value: "Early", label: "Mover advantage available now" },
  { value: "3–6", label: "Months to AI visibility" },
  { value: "↑", label: "AI search growing monthly" },
];

export default function LlmSeoResults() {
