...
export default function LlmSeoHero() {
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              AEO Services —{" "}
              <span className="text-orange-500">Get Your Business Found in AI Search</span>
            </motion.h1>
            ...
            >
              Answer Engine Optimization for the new era of search. I help Melbourne
              businesses get cited, recommended, and surfaced by ChatGPT, Perplexity,
              Google AI Overviews, and other AI-powered search tools.
            </motion.p>
            ...
            >
              Search is evolving. Millions of people now ask AI assistants for
              recommendations instead of scrolling through Google results. If your
              business isn&apos;t optimised for answer engines, you&apos;re becoming invisible
            ...
            >
              {["✓ ChatGPT visibility", "✓ Perplexity optimisation", "✓ Google AI Overviews", "✓ No lock-in contracts"].map((item) => (
          ...
          >
            {[
              { value: "3+", label: "AI platforms optimised for" },
              { value: "Early", label: "Mover advantage — most haven't caught on" },
              { value: "3–6", label: "Months to meaningful AI visibility" },
              { value: "↑", label: "AI search usage growing every month" },
            ].map((stat) => (
              <div
                key={stat.label}
