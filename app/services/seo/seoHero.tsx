      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              SEO That Actually{" "}
              <span className="text-orange-500">Grows Your Business</span>
            </motion.h1>
            ...
            >
              Tired of paying for SEO and seeing nothing? No contracts. No vanity metrics.
              No excuses. Just transparent search engine optimisation that actually grows
              your Melbourne business.
            </motion.p>
            ...
            >
              {["✓ No lock-in contracts", "✓ Month-to-month", "✓ Full transparency", "✓ Results-focused"].map((item) => (
