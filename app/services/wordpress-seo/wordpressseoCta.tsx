...
export default function WordPressSeoCta() {
        ...
        <div className="bg-[#141414] border border-gray-800 rounded-2xl
          ...
          <motion.h2
            ...
            className="text-white text-3xl md:text-4xl lg:text-5xl font-extrabold
                       leading-tight mb-6"
          >
            Let&apos;s Unlock Your WordPress Site&apos;s{" "}
            <span className="text-orange-500">Full Potential</span>
          </motion.h2>
          ...
          >
            Find out what&apos;s holding your site back. Get a free WordPress SEO audit —
            I&apos;ll analyse your technical setup, plugin configuration, speed, and
            content, then show you exactly how to improve.
          </motion.p>
          ...
          >
            {["✓ No lock-in contracts", "✓ All plugins supported", "✓ Direct access to Bhavleen", "✓ WooCommerce ready"].map((item) => (
