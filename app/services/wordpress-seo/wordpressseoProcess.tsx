...
const steps = [
  {
    ...
    desc: "I analyse your site's technical health, plugin setup, theme performance, content, and structure. You'll see exactly what's working and what's not.",
    time: "3–5 days",
  },
  {
    number: "02",
    title: "Technical Optimisation",
    desc: "I fix speed issues, configure caching, clean up bloat, and resolve any crawl or indexing problems holding your rankings back.",
    time: "1–2 weeks",
  },
  {
    number: "03",
    title: "On-Page Optimisation",
    desc: "I optimise your key pages — titles, descriptions, headings, content, and internal links — for your target keywords.",
    time: "1–2 weeks",
  },
  {
    number: "04",
    title: "Plugin & Theme Review",
    desc: "I audit your plugins and theme, removing what's hurting performance and properly configuring what stays.",
    time: "2–3 days",
  },
  {
    number: "05",
    title: "Content Strategy",
    desc: "I develop a content plan that targets valuable keywords, fills gaps, and builds topical authority over time.",
    time: "1 week",
  },
  {
    number: "06",
    title: "Ongoing Optimisation",
    desc: "SEO isn't set-and-forget. I monitor performance, update content, and continuously improve as your site grows.",
    time: "Monthly",
  },
];

export default function WordPressSeoProcess() {
  ...
  return (
    <section className="bg-[#0f0f0f] py-24 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          How I Optimise{" "}
          <span className="text-orange-500">WordPress Sites</span>
        </motion.h2>
