...
const testimonials = [
  {
    quote: "Our WordPress site was painfully slow and barely ranking. Bhavleen cleaned up the bloat, fixed our technical issues, and now we're on page one for our main keywords.",
    name: "Client Name",
  ...
  {
    quote: "I thought I had Yoast set up correctly — turns out I'd missed half the settings. Bhavleen configured everything properly and our traffic jumped within weeks.",
    name: "Client Name",
    role: "Business Owner, Melbourne",
    initials: "CN",
    result: "Traffic Jump",
...
const stats = [
  ...
  { value: "3–6", label: "Months to see results" },
  { value: "Page 1", label: "Target for main keywords" },
  { value: "Weeks", label: "For quick wins to show" },
];

export default function WordPressSeoResults() {
