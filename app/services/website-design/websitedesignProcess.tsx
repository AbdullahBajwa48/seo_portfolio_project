...
const steps = [
  {
    ...
    desc: "We discuss your business, goals, target audience, and what you need from your website. I assess your current situation and identify keyword opportunities.",
    time: "1–2 days",
  },
  {
    number: "02",
    title: "Strategy & Architecture",
    desc: "I plan your site structure, navigation, and page hierarchy — ensuring everything is set up for SEO success before design begins.",
    time: "1 week",
  },
  {
    number: "03",
    title: "Design & Development",
    desc: "I create your website — custom design, mobile-responsive, fast-loading, and built with clean code. You'll review and provide feedback throughout.",
    time: "2–3 weeks",
  },
  {
    number: "04",
    title: "SEO Configuration",
    desc: "Before launch, I configure all technical SEO elements — schema markup, sitemaps, meta tags, analytics, and Search Console integration.",
    time: "3–5 days",
  },
  {
    number: "05",
    title: "Launch & Handover",
    desc: "Your site goes live. I walk you through how to manage it, make updates, and maintain performance. Ongoing support is available if needed.",
    time: "1–2 days",
  },
];
  ...
  return (
    <section className="bg-[#0f0f0f] py-24 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          How I{" "}
          <span className="text-orange-500">Build Websites</span>
        </motion.h2>
