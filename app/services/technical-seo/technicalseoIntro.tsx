...
const pillars = [
  { icon: "⚡", text: "Site speed optimisation" },
  { icon: "📱", text: "Mobile-first fixes" },
  { icon: "🕷️", text: "Crawl error resolution" },
  { icon: "🔒", text: "Security & HTTPS" },
];

export default function TechnicalSeoIntro() {
    ...
    <section className="bg-[#0f0f0f] py-24 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        <div className="max-w-3xl mx-auto space-y-5 mb-14">
          ...
          >
            Great content and strong backlinks mean nothing if Google can&apos;t crawl your site.
          </motion.p>
          ...
          >
            Technical SEO is the behind-the-scenes work that ensures search engines can
            crawl your site, index your pages, and understand your content. It covers
            everything from site speed and mobile usability to crawl errors, duplicate
          ...
          <motion.p
            ...
            className="text-gray-400 text-base leading-relaxed text-center"
          >
            Most business owners don&apos;t even know these issues exist. They just wonder
            why their site isn&apos;t ranking — while the real problems stay buried in the code.
          </motion.p>
          ...
          <motion.p
            ...
            className="text-gray-400 text-base leading-relaxed text-center"
          >
            That&apos;s where I come in. I find what&apos;s broken, explain it in plain English,
            and fix it — so your rankings can actually reflect the quality of your business.
          </motion.p>
        </div>
