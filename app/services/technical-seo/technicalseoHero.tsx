      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Technical SEO Melbourne —{" "}
              <span className="text-orange-500">Fix What&apos;s Holding Your Rankings Back</span>
            </motion.h1>
            ...
            >
              Your website might look great — but if Google can&apos;t crawl, index, or
              understand it properly, you won&apos;t rank. I find and fix the technical
              issues silently killing your organic visibility.
            </motion.p>
            ...
            >
              Technical SEO is the foundation everything else is built on. Without it,
              your content and backlinks won&apos;t deliver the results they should. I help
              Melbourne businesses identify and resolve the hidden technical problems
            ...
            >
              {["✓ No lock-in contracts", "✓ Month-to-month", "✓ Full audit included", "✓ Results-focused"].map((item) => (
          ...
          >
            {[
              { value: "3–5", label: "Days for full audit" },
              { value: "<2s", label: "Target page load time" },
              { value: "10+", label: "Technical checks performed" },
