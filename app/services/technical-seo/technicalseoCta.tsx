...
export default function TechnicalSeoCta() {
      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="bg-[#141414] border border-gray-800 rounded-2xl
          ...
          >
            ...
            <span className="text-orange-500">Your Site Back</span>
          </motion.h2>
          ...
          >
            Get a free technical SEO audit. I&apos;ll crawl your website, identify the
            issues affecting your rankings, and show you exactly what needs to be fixed
            — no jargon, no obligations.
          </motion.p>
