...
const steps = [
  {
    ...
    desc: "I analyse every key page on your site — current keyword targeting, title tags, meta descriptions, headings, content quality, and internal links.",
    time: "3–5 days",
  },
  {
    number: "02",
    title: "Keyword Mapping",
    desc: "I assign primary and secondary keywords to each page based on search volume, intent, and your business priorities.",
    time: "2–3 days",
  },
  {
    number: "03",
    title: "Optimisation Plan",
    desc: "You receive a prioritised list of on-page improvements — what to fix, what to rewrite, and what to create.",
    time: "1–2 days",
  },
  {
    number: "04",
    title: "Implementation",
    desc: "I make the changes directly (if I have access) or provide detailed briefs for you or your developer to implement.",
    time: "1–2 weeks",
  },
  {
    number: "05",
    title: "Performance Tracking",
    desc: "After optimisation, I track ranking movements and traffic changes to measure impact and identify further opportunities.",
    time: "Monthly",
  },
];
