      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              On-Page SEO Melbourne —{" "}
              <span className="text-orange-500">Optimise Every Page for Rankings</span>
            </motion.h1>
            ...
            >
              Strategic on-page optimisation that tells Google exactly what your pages
              are about — and convinces visitors to take action.
            </motion.p>
            ...
            >
              On-page SEO is where content meets strategy. I optimise your titles, meta
              descriptions, headings, content structure, and internal links to help every
              page rank higher and convert better.
            </motion.p>
            ...
            >
              {["✓ No lock-in contracts", "✓ Month-to-month", "✓ Page-by-page audit", "✓ Results-focused"].map((item) => (
          ...
          >
            {[
              { value: "1–2", label: "Weeks to optimise a small site" },
              { value: "9", label: "On-page elements optimised" },
              { value: "2mo", label: "Avg time to see ranking lifts" },
              { value: "100%", label: "Pages audited individually" },
            ].map((stat) => (
              <div
                key={stat.label}
