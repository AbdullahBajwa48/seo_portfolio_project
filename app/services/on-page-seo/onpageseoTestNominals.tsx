...
const testimonials = [
  {
    quote: "Bhavleen rewrote our title tags and restructured our service pages. Within two months, we jumped from page 3 to the top 5 for our main keywords.",
    name: "Client Name",
  ...
  {
    quote: "I didn't realise how poorly optimised our site was until Bhavleen walked me through it. The changes were straightforward but the impact was huge.",
    name: "Client Name",
    role: "Business Owner, Melbourne",
    initials: "CN",
    result: "Huge Impact",
...
const stats = [
  ...
  { value: "9", label: "On-page elements per page" },
  { value: "Top 5", label: "Target for main keywords" },
  { value: "100%", label: "Pages audited" },
];
