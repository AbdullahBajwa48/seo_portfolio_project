...
const pillars = [
  { icon: "🔗", text: "Quality backlinks" },
  { icon: "📋", text: "Local citations" },
  { icon: "🏆", text: "Domain authority" },
  { icon: "📍", text: "Local trust signals" },
];

export default function LinkBuildingIntro() {
  ...
  return (
    <section className="bg-[#0f0f0f] py-24 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          Why <span className="text-orange-500">Link Building</span> Matters
        </motion.h2>
        ...
        <div className="max-w-3xl mx-auto space-y-5 mb-14">
          ...
          >
            Backlinks act as votes of confidence — and Google still counts every one.
          </motion.p>
          ...
          >
            Google&apos;s algorithm was built on one core idea: pages that other websites
            link to are more trustworthy and valuable than pages nobody references.
            That principle still holds today. The more quality links pointing to your
            site, the more authority you build — and the higher you rank.
          </motion.p>
          ...
          <motion.p
            ...
            className="text-gray-400 text-base leading-relaxed text-center"
          >
            But link building isn&apos;t just about backlinks. For local businesses,
            citations — mentions of your business name, address, and phone number on
            directories — are equally critical. They establish trust, verify your
            legitimacy, and directly impact local search rankings.
          </motion.p>
          ...
          <motion.p
            ...
            className="text-gray-400 text-base leading-relaxed text-center"
          >
            At Khalis Marketing, I focus on both. Backlinks for domain authority.
            Citations for local trust. Together, they create the foundation for
