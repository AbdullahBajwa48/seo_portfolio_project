...
export default function LinkBuildingCta() {
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="bg-[#141414] border border-gray-800 rounded-2xl
          ...
          >
            Ready to Build{" "}
            <span className="text-orange-500">Real Authority?</span>
          </motion.h2>
          ...
          >
            Find out where your link profile stands. Get a free audit and I&apos;ll show
            you your current backlinks, citation health, and exactly what it takes to
            build the authority you need to rank.
          </motion.p>
