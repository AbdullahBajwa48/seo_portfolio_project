...
export default function LinkBuildingHero() {
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Link Building Melbourne —{" "}
              <span className="text-orange-500">Build Authority That Google Trusts</span>
            </motion.h1>
            ...
            >
              Quality backlinks and local citations are the foundation of SEO success.
              I build both — earning your site the authority it needs to outrank competitors.
            </motion.p>
            ...
            >
              Links remain one of Google&apos;s strongest ranking signals. Without them,
              even perfectly optimised content struggles to rank. I help Melbourne
              businesses build genuine authority through strategic backlink acquisition
              and comprehensive local citation building.
            </motion.p>
            ...
            >
              {["✓ No spammy links", "✓ Full transparency", "✓ Monthly reports", "✓ No lock-in contracts"].map((item) => (
          ...
          >
            {[
              { value: "5–15", label: "Quality backlinks per month" },
              { value: "2–4", label: "Months to see results" },
              { value: "0", label: "Spammy or risky links built" },
              { value: "100%", label: "Link transparency" },
            ].map((stat) => (
              <div
                key={stat.label}
