...
const testimonials = [
  {
    quote: "We had zero backlinks and our citations were a mess. Bhavleen cleaned everything up and started building real links. Our rankings jumped within three months.",
    name: "Client Name",
    role: "Business Owner, Melbourne",
    initials: "CN",
    result: "Rankings in 3 Months",
  },
  {
    quote: "Other agencies just talked about links. Bhavleen actually showed me every single one he built — where it came from and why it mattered. Completely transparent.",
    name: "Client Name",
    role: "Business Owner, Melbourne",
    initials: "CN",
...
const stats = [
  ...
  { value: "0", label: "Spammy or risky links" },
  { value: "100%", label: "Link transparency" },
];

export default function LinkBuildingResults() {
