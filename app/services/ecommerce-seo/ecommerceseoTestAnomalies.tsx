...
const testimonials = [
  {
    quote: "We were spending $15k/month on ads with thin margins. Bhavleen built our organic channel from scratch — now 40% of our revenue comes from SEO with zero ad spend.",
    name: "Client Name",
    role: "Online Retailer, Melbourne",
    initials: "CN",
    result: "40% Revenue from Organic",
  },
  {
    quote: "Our product pages were a mess. Bhavleen restructured everything, optimised our top categories, and traffic doubled in four months. More importantly, sales doubled too.",
    name: "Client Name",
    role: "Ecommerce Store, Melbourne",
    initials: "CN",
    result: "2x Traffic & Sales",
  },
];

const stats = [
  { value: "40%", label: "Revenue from organic search" },
  { value: "2x", label: "Traffic & sales increase" },
  { value: "3–6", label: "Months to results" },
  { value: "$0", label: "Ad spend to maintain organic" },
];
