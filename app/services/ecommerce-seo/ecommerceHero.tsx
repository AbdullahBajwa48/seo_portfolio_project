      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Ecommerce SEO Melbourne —{" "}
              <span className="text-orange-500">Drive Organic Sales, Not Just Traffic</span>
            </motion.h1>
            ...
            >
              SEO for online stores that turns browsers into buyers. I help ecommerce
              businesses rank for high-intent product searches and build a sustainable
              revenue channel beyond paid ads.
            </motion.p>
            ...
            >
              Paid ads stop working the moment you stop paying. Ecommerce SEO builds
              organic visibility that compounds over time — driving sales month after
              month without paying for every click.
            </motion.p>
            ...
            >
              {["✓ Ecommerce specialist", "✓ Product & category pages", "✓ Revenue-focused", "✓ No lock-in contracts"].map((item) => (
          ...
          >
            {[
              { value: "40%", label: "Revenue from organic for clients" },
              { value: "2x", label: "Traffic & sales in 4 months" },
              { value: "3–6", label: "Months to measurable results" },
              { value: "$0", label: "Ad spend needed to maintain organic" },
            ].map((stat) => (
              <div
                key={stat.label}
