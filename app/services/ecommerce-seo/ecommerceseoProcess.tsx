...
const steps = [
  {
    number: "01",
    title: "Store Audit",
    desc: "I analyse your site's technical foundation, structure, content, and backlink profile. This reveals what's working, what's broken, and where opportunities exist.",
    time: "3–5 days",
  },
  {
    number: "02",
    title: "Competitor Research",
    desc: "I study competitors ranking for your target keywords — their site structure, top pages, content strategy, and backlink sources. This shapes your competitive strategy.",
    time: "1 week",
  },
  {
    number: "03",
    title: "Keyword Mapping",
    desc: "I map keywords to product pages, category pages, and content opportunities — ensuring every important page has a clear ranking target.",
    time: "1 week",
  },
  {
    number: "04",
    title: "Optimisation & Implementation",
    desc: "I optimise your existing pages, fix technical issues, implement schema markup, and create or improve content. Priority goes to highest-impact opportunities first.",
    time: "1–2 weeks",
  },
  {
    number: "05",
    title: "Link Building & Promotion",
    desc: "I build quality backlinks to your store and key pages, increasing domain authority and helping you compete for competitive product terms.",
    time: "Ongoing",
  },
  {
    number: "06",
    title: "Monitor & Scale",
    desc: "I track rankings, traffic, and revenue from organic search. As results grow, we expand to more products, categories, and content opportunities.",
    time: "Monthly",
  },
];
  ...
  return (
    <section className="bg-[#0a0a0a] py-24 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          How I Approach{" "}
          <span className="text-orange-500">Ecommerce SEO</span>
        </motion.h2>
