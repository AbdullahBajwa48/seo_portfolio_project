      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="bg-[#141414] border border-gray-800 rounded-2xl
          ...
          >
            ...
            <span className="text-orange-500">With SEO?</span>
          </motion.h2>
          ...
          >
            Find out how your store stacks up. Get a free ecommerce SEO audit — I&apos;ll
            analyse your site structure, product pages, technical health, and competitor
            positioning, then show you exactly what it takes to grow organic sales.
          </motion.p>
          ...
          >
            {["✓ No lock-in contracts", "✓ All platforms supported", "✓ Direct access to Bhavleen", "✓ Revenue-focused strategy"].map((item) => (
