...
const testimonials = [
  {
    quote: "We were burning cash on Google Ads. Bhavleen built our organic channel from scratch — now 40% of our trial signups come from SEO at a fraction of the cost.",
    name: "Client Name",
    role: "SaaS Founder, Melbourne",
    initials: "CN",
    result: "40% Signups from SEO",
  },
  {
    quote: "Our comparison pages alone generate 200+ leads per month. Bhavleen understood exactly how SaaS buyers search and built content that captures them.",
    name: "Client Name",
    role: "SaaS Founder, Melbourne",
    initials: "CN",
...
const stats = [
  { value: "40%", label: "Trial signups from SEO" },
  { value: "200+", label: "Monthly leads from comparison pages" },
  { value: "↓ CAC", label: "Reduced cost per acquisition" },
  { value: "4–6mo", label: "To meaningful growth" },
];

export default function SaasSeoResults() {
  ...
  return (
    <section className="bg-[#0f0f0f] py-24 px-6 md:px-16 lg:px-24">
      <div className="max-w-6xl mx-auto" ref={ref}>
        ...
        >
          What SaaS <span className="text-orange-500">Founders Say</span>
        </motion.h2>
