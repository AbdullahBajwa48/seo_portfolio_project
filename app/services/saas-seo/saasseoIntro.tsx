...
const pillars = [
  { icon: "🎯", text: "Full buyer journey" },
  { icon: "📈", text: "Signup-focused content" },
  { icon: "🏆", text: "Topical authority" },
  { icon: "💰", text: "Lower CAC over time" },
];

export default function SaasSeoIntro() {
  ...
  return (
    <section className="bg-[#0f0f0f] py-24 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          Why SaaS Companies Need a{" "}
          <span className="text-orange-500">Different SEO Approach</span>
        </motion.h2>
        ...
        <div className="max-w-3xl mx-auto space-y-5 mb-14">
          ...
          >
            Your buyers are searching right now — for your competitors, your category, and your product&apos;s exact problems.
          </motion.p>
          ...
          >
            SaaS SEO isn&apos;t like local SEO or e-commerce SEO. You&apos;re not optimising for
            foot traffic or product purchases. You&apos;re building a funnel that captures
            potential customers at every stage — from problem-aware to solution-ready.
          </motion.p>
          ...
          <motion.p
            ...
            className="text-gray-400 text-base leading-relaxed text-center"
          >
            The SaaS companies winning at organic search aren&apos;t just ranking for their
            brand name. They&apos;re owning entire topic clusters — educational content that
            builds trust, comparison pages that capture high-intent traffic, and product
            pages optimised to convert.
          </motion.p>
          ...
          <motion.p
            ...
            className="text-gray-400 text-base leading-relaxed text-center"
          >
            I help Melbourne SaaS businesses build SEO strategies that drive qualified
            signups, not just traffic numbers.
          </motion.p>
        </div>
