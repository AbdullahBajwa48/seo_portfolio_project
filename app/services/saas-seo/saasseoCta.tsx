...
export default function SaasSeoCta() {
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="bg-[#141414] border border-gray-800 rounded-2xl
          ...
          >
            Ready to Build Your{" "}
            <span className="text-orange-500">Organic Growth Engine?</span>
          </motion.h2>
          ...
          >
            Find out where your SaaS SEO opportunities are. Get a free audit — I&apos;ll
            analyse your current organic performance, content gaps, and competitor
            positioning, then show you exactly how to grow.
          </motion.p>
          ...
          >
            {["✓ No lock-in contracts", "✓ Signup-focused strategy", "✓ Direct access to Bhavleen", "✓ Full conversion tracking"].map((item) => (
