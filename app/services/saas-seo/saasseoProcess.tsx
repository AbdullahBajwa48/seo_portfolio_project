...
const steps = [
  {
    ...
    desc: "I analyse your current organic performance — technical foundation, content assets, keyword rankings, and competitor positioning. You'll see exactly where opportunities exist.",
    time: "3–5 days",
  },
  {
    number: "02",
    title: "Keyword & Content Strategy",
    desc: "I map keywords across the full buyer journey — awareness, consideration, and decision stages — and develop a content plan that captures traffic at each stage.",
    time: "1 week",
  },
  {
    number: "03",
    title: "Technical Optimisation",
    desc: "I fix technical issues affecting crawlability, speed, and indexing. SaaS sites often have app-related technical challenges that need specialist attention.",
    time: "1–2 weeks",
  },
  {
    number: "04",
    title: "Content Development",
    desc: "I create or optimise content targeting your priority keywords — blog posts, comparison pages, feature pages, and conversion-focused landing pages.",
    time: "Ongoing",
  },
  {
    number: "05",
    title: "Link Building",
    desc: "I earn quality backlinks through content promotion, digital PR, guest posting, and industry outreach — building the authority needed to compete.",
    time: "Ongoing",
  },
  {
    number: "06",
    title: "Track, Report, Improve",
    desc: "I connect SEO to business metrics — signups, demos, trials, revenue. Monthly reporting shows exactly what's working and where we're doubling down.",
    time: "Monthly",
  },
];

export default function SaasSeoProcess() {
  ...
  return (
    <section className="bg-[#0a0a0a] py-24 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          How I Approach{" "}
          <span className="text-orange-500">SaaS SEO</span>
        </motion.h2>
