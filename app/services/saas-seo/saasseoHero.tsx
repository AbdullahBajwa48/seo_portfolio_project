...
export default function SaasSeoHero() {
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              SaaS SEO Melbourne —{" "}
              <span className="text-orange-500">Grow Your Software Business With Organic Search</span>
            </motion.h1>
            ...
            >
              SEO for SaaS companies that drives signups, demos, and recurring revenue.
              I help software businesses build organic acquisition channels that scale
            ...
            >
              Paid acquisition gets expensive fast. SaaS SEO builds a compounding asset
              — content and rankings that drive qualified leads month after month,
            ...
            >
              {["✓ Full-funnel strategy", "✓ Signup-focused", "✓ CAC reduction", "✓ No lock-in contracts"].map((item) => (
          ...
          >
            {[
              { value: "40%", label: "Of trial signups from SEO for clients" },
              { value: "4–6", label: "Months to meaningful traffic growth" },
              { value: "200+", label: "Monthly leads from comparison pages" },
              { value: "↓ CAC", label: "SEO reduces your cost per acquisition" },
            ].map((stat) => (
              <div
                key={stat.label}
