      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Local SEO Melbourne —{" "}
              <span className="text-orange-500">Dominate Your Area on Google</span>
            </motion.h1>
            ...
            >
              Get found by customers in your suburb, your city, and your service area.
              Local SEO that puts your business in the map pack and drives calls,
              enquiries, and foot traffic.
            </motion.p>
            ...
            >
              When Melbourne customers search for services &quot;near me,&quot; your business
              should be the one they find. I help local businesses rank higher in Google
              Maps and local search results — so you get more leads from people ready to buy.
            </motion.p>
            ...
            >
              {["✓ No lock-in contracts", "✓ Month-to-month", "✓ Map pack focused", "✓ Results-driven"].map((item) => (
          ...
          >
            {[
              { value: "2–4", label: "Months to see local results" },
              { value: "Top 3", label: "Map pack target" },
              { value: "312%", label: "Avg traffic increase" },
              { value: "3x", label: "More local enquiries" },
            ].map((stat) => (
              <div
                key={stat.label}
