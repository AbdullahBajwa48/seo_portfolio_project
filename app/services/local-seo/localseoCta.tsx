      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="bg-[#141414] border border-gray-800 rounded-2xl
          ...
          >
            ...
            <span className="text-orange-500">in Melbourne?</span>
          </motion.h2>
          ...
          >
            Find out exactly where your business stands in local search. Get a free
            local SEO audit — I&apos;ll analyse your Google Business Profile, citations,
            reviews, and local rankings, then show you what it takes to get into the map pack.
          </motion.p>
