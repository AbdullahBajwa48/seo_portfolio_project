...
export default function ShopifySeoCta() {
        ...
        <div className="bg-[#141414] border border-gray-800 rounded-2xl
          ...
          <motion.h2
            ...
            className="text-white text-3xl md:text-4xl lg:text-5xl font-extrabold
                       leading-tight mb-6"
          >
            Let&apos;s Unlock Your Shopify Store&apos;s{" "}
            <span className="text-orange-500">SEO Potential</span>
          </motion.h2>
          ...
          >
            Find out what&apos;s holding your store back. Get a free Shopify SEO audit —
            I&apos;ll analyse your site structure, technical health, and product pages, then
            show you exactly how to improve your organic visibility.
          </motion.p>
          ...
          >
            {["✓ No lock-in contracts", "✓ Shopify admin access optional", "✓ Direct access to Bhavleen", "✓ App audit included"].map((item) => (
