...
export default function ShopifySeoHero() {
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Shopify SEO Melbourne —{" "}
              <span className="text-orange-500">Unlock Your Store&apos;s Organic Potential</span>
            </motion.h1>
            ...
            >
              Shopify is built for selling — but out of the box, it&apos;s not built for SEO.
              I fix that. Strategic optimisation that helps your Shopify store rank higher
              and sell more.
            </motion.p>
            ...
            >
              Shopify powers millions of stores, but most owners don&apos;t realise the
              platform has SEO limitations baked in. I help Melbourne Shopify businesses
              work around those limitations and build organic traffic that drives sales.
            </motion.p>
            ...
            >
              {["✓ Shopify specialist", "✓ Product & collection pages", "✓ App audit included", "✓ No lock-in contracts"].map((item) => (
          ...
          >
            {[
              { value: "3x", label: "Organic traffic increase for clients" },
              { value: "35%", label: "Of sales from organic after SEO" },
              { value: "3–6", label: "Months to measurable results" },
              { value: "5", label: "Shopify-specific SEO challenges fixed" },
            ].map((stat) => (
              <div
                key={stat.label}
