...
const testimonials = [
  {
    quote: "I didn't realise Shopify had so many SEO issues until Bhavleen audited our store. He fixed problems our previous agency never mentioned — and our organic traffic has tripled.",
    name: "Client Name",
    role: "Shopify Store Owner, Melbourne",
    initials: "CN",
    result: "3x Organic Traffic",
  },
  {
    quote: "We were 100% dependent on Facebook ads. Bhavleen built our organic channel from nothing — now 35% of sales come from Google without spending a cent on ads.",
    name: "Client Name",
    role: "Shopify Store Owner, Melbourne",
    initials: "CN",
    result: "35% Sales from Organic",
  },
];

const stats = [
  { value: "3x", label: "Organic traffic increase" },
  { value: "35%", label: "Sales from organic search" },
  { value: "3–6", label: "Months to results" },
  { value: "0", label: "Ad spend to maintain organic" },
];

export default function ShopifySeoResults() {
