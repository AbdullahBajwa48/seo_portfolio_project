...
const steps = [
  {
    ...
    desc: "I analyse your store's current SEO performance — technical issues, content gaps, structure problems, and competitor positioning.",
    time: "3–5 days",
  },
  {
    number: "02",
    title: "Keyword Mapping",
    desc: "I map target keywords to your products, collections, and content opportunities — ensuring every important page has a clear focus.",
    time: "1 week",
  },
  {
    number: "03",
    title: "Technical Fixes",
    desc: "I address Shopify-specific issues — duplicate content, canonical tags, site speed, auto-generated pages, and crawlability.",
    time: "1–2 weeks",
  },
  {
    number: "04",
    title: "On-Page Optimisation",
    desc: "I optimise your product pages, collection pages, and homepage — titles, descriptions, headings, images, and internal links.",
    time: "1–2 weeks",
  },
  {
    number: "05",
    title: "Content Development",
    desc: "I create or optimise blog content and supporting pages that capture traffic earlier in the buyer journey and build topical authority.",
    time: "Ongoing",
  },
  {
    number: "06",
    title: "Monitor & Improve",
    desc: "I track rankings, traffic, and sales from organic search — refining the strategy based on what's actually driving results.",
    time: "Monthly",
  },
];
  ...
  return (
    <section className="bg-[#0a0a0a] py-24 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          How I Optimise{" "}
          <span className="text-orange-500">Shopify Stores</span>
        </motion.h2>
