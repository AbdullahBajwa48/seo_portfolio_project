...
export default function AboutCTA() {
  ...
  return (
    ...
    >
      {/* Top fade from white to dark */}
      <div className="absolute top-0 left-0 right-0 h-20
                      bg-gradient-to-b from-gray-50 to-transparent pointer-events-none" />
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-orange-500">SEO Goals</span>
        </motion.h2>
        ...
        >
          ...
          where your business is, where you want it to be, and whether I can
          help you get there.
        </motion.p>
