...
export default function HoppersCta() {
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="bg-[#141414] border border-gray-800 rounded-2xl
          ...
          >
            Free Hoppers Crossing SEO Audit
          </motion.p>
          ...
          >
            ...
            <span className="text-orange-500">in Hoppers Crossing</span>
          </motion.h2>
          ...
          >
            Get a clear picture of your local search visibility. I&apos;ll show you which
            searches you&apos;re winning, which you&apos;re losing, and exactly what it takes
            to improve.
          </motion.p>
          ...
          >
            ...
            >
              Get Your Free Hoppers Crossing SEO Audit
          ...
          >
            {[
              ...
              "✓ Hoppers Crossing-specific strategy",
