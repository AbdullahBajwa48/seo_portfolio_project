...
export default function HoppersHero() {
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Get found when Hoppers Crossing residents search for businesses like
              yours. Local SEO that puts you ahead of the competition.
            </motion.p>
          ...
          >
            {[
              { value: "Top 3", label: "Map Pack positions where the real leads come from" },
              { value: "3–6", label: "Months to meaningful ranking results" },
              { value: "Local", label: "Search terms researched specifically for your area" },
