...
export default function TarneitCta() {
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="bg-[#141414] border border-gray-800 rounded-2xl
          ...
          >
            Get Ahead of{" "}
            <span className="text-orange-500">Tarneit&apos;s Growth</span>
          </motion.h2>
          ...
          >
            See where you currently rank for Tarneit searches — and where the gaps are.
            I&apos;ll audit your visibility and show you exactly how to capture more of
            this growing market.
          </motion.p>
          ...
          >
            ...
            >
              Get Your Free Tarneit SEO Audit
          ...
          >
            {[
              ...
              "✓ Tarneit-specific strategy",
              "✓ Direct access to Bhavleen",
              "✓ Estate-level targeting",
            ].map((item) => (
