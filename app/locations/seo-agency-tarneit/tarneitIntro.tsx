...
const pillars = [
  { icon: "🏘️", text: "New estate targeting" },
  { icon: "🔍", text: "Discovery search strategy" },
  { icon: "📈", text: "Early mover advantage" },
  { icon: "📝", text: "Tarneit-specific content" },
];

export default function TarneitIntro() {
  ...
  return (
    <section className="bg-[#0f0f0f] py-24 px-6 md:px-16 lg:px-24">
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          SEO Services for{" "}
          <span className="text-orange-500">Tarneit Businesses</span>
        </motion.h2>
        ...
        <div className="max-w-3xl mx-auto space-y-5 mb-14">
          ...
          >
            Tarneit is one of Australia&apos;s fastest-growing suburbs — and new residents are Googling for services right now.
          </motion.p>
          ...
          >
            New estates like Rothwell, Riverdale, and Elements keep expanding. The new
            Tarneit Central shopping district is taking shape. Families are moving in
          ...
          <motion.p
            ...
            className="text-gray-400 text-base leading-relaxed text-center"
          >
            Every new household needs services — a dentist, a mechanic, a reliable
            plumber, somewhere to grab dinner. They don&apos;t have recommendations yet.
            They&apos;re not asking neighbours. They&apos;re Googling. &ldquo;Dentist Tarneit.&rdquo;
            &ldquo;Best pizza Tarneit.&rdquo; &ldquo;Emergency electrician near me.&rdquo;
          </motion.p>
          ...
          <motion.p
            ...
            className="text-gray-400 text-base leading-relaxed text-center"
          >
            Whoever ranks first gets the call. I help Tarneit businesses be that
            first result — before the competition catches on.
          </motion.p>
        </div>
