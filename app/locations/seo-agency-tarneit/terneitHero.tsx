...
export default function TarneitHero() {
    ...
    <section className="relative bg-[#0a0a0a] pt-32 pb-24 px-6 md:px-16 lg:px-24 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              ...
              <span className="text-orange-500">
                Reach New Residents Before Your Competitors Do
              </span>
            </motion.h1>
            ...
            >
              Thousands of families move to Tarneit every year. They&apos;re searching
              for local services right now. Are they finding you?
            </motion.p>
          ...
          >
            {[
              { value: "#1", label: "Fastest-growing suburb ranking Tarneit consistently holds" },
              { value: "1000s", label: "New families arriving in Tarneit every year" },
              { value: "Now", label: "The window to build rankings before competition stiffens" },
              { value: "Years", label: "Of compounding returns from SEO foundations built today" },
            ].map((stat) => (
              <div
                key={stat.label}
