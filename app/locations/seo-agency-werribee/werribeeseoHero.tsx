...
export default function WerribeeHero() {
      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              Rank higher in Google Search and Maps. Turn local searches into
              paying customers.
            </motion.p>
          ...
          >
            {[
              { value: "#1", label: "Where your business needs to be in local search" },
              { value: "3–6", label: "Months to meaningful ranking results" },
              { value: "46%", label: "Of Google searches have local intent" },
              { value: "5★", label: "Review strategy built into every engagement" },
            ].map((stat) => (
              <div
                key={stat.label}
