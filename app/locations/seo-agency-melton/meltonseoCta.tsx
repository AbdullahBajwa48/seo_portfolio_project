...
export default function MeltonCta() {
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="bg-[#141414] border border-gray-800 rounded-2xl
          ...
          >
            See How You Rank{" "}
            <span className="text-orange-500">Across Melton</span>
          </motion.h2>
          ...
          >
            I&apos;ll show you where you&apos;re visible in Melton search results and where
            opportunities exist. A free audit with no strings attached.
          </motion.p>
          ...
          >
            ...
            >
              Get Your Free Melton SEO Audit
